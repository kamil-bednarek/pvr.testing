...
PVRTestingData   *m_data           = NULL;
bool           m_bIsPlaying     = false;
PVRTestingChannel m_currentChannel;
...
ADDON_STATUS ADDON_Create(void* hdl, void* props)
{
  ...
  XBMC->Log(LOG_DEBUG, "%s - Creating the PVR testing add-on", __FUNCTION__);
...
{
  static const char *strBackendName = "pulse-eight testing pvr add-on";
...
{
  snprintf(signalStatus.strAdapterName, sizeof(signalStatus.strAdapterName), "pvr testing adapter 1");
